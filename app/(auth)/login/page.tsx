...
export default function UserLoginPage() {
  ...
  return (
    <main className='flex h-screen w-full flex-col items-center justify-center bg-black bg-opacity-70'>
      <div className='flex h-[70%] max-h-[800px] w-[80%] max-w-[700px] flex-col gap-8 rounded-2xl bg-white px-6 py-5 sm:h-full sm:max-h-[700px] sm:px-8 sm:py-6 md:px-10 md:py-8 lg:gap-12 lg:rounded-3xl lg:px-12 lg:py-10 2xl:px-16 2xl:py-12'>
        {isForgotPassword ? (
          <>
            {/* Close BUtton */}
              ...
              >
                ...
                <div className='flex flex-col gap-5'>
                  <>
                    ...
                    {/* Input field */}
                    {StepForgotPasswordContent[step - 1].input.map(
                      (input, index) => {
                        return (
                          <div
                            ...
                            {input.type === 'password' ? (
                              ...
                              <>
                                ...
                                <input
                                  ...
                                  id={input.id}
                                  value={
                                    step === StepForgotPassEnum.OTP ? pin : ''
                                  }
                                  onChange={(e) =>
