...
export default function Footer() {
  return (
    <footer className="flex flex-col bg-[#E6E6E6] px-8 py-10 text-black md:px-12 lg:px-20">
      {/* Upper Main Content */}
      <div className="flex flex-col justify-around gap-10 pb-5 text-base lg:text-lg xl:text-xl 2xl:text-2xl xl:flex-row">
        {/* Subcription Content */}
        <div className="max-xl flex flex-col max-xl:items-center gap-1">
          <p className="text-2xl xl:text-[26px] 2xl:text-3xl font-bold text-primary-2">
            Ikuti Berita terbaru Khaloo
          </p>
          <p className="text-sm lg:text-base font-semibold text-secondary-1">
